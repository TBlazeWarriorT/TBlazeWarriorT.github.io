		...
		var UIFunctions = Ash.Class.extend({
			...
			generateActionButtonCallout: function (action) {
                ...
                */
				...
				var fightRiskMax = PlayerActionConstants.getRandomEncounterProbability(baseActionId, 0, encounterFactor);
				var fightRiskMin = PlayerActionConstants.getRandomEncounterProbability(baseActionId, 100, encounterFactor);
			...
			getGameInfoDiv: function () {
				...
				html += "<p>Note that this game is still in development and many features are incomplete and unbalanced. Updates might break saves. Feedback and bug reports are appreciated!<p>TBlazeWarriorT was here.</p></p>";
